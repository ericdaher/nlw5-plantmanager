...
import { Alert, StyleSheet, Text, View, Image, ScrollView, TouchableOpacity, Platform } from "react-native";
      ...
      <View style={styles.container}>
        ...
        <View style={styles.controller}>
          <View style={styles.tipContainer}>
            <Image source={waterdropImg} style={styles.tipImage}></Image>
          ...
          <Button text="Cadastrar planta" onPress={handleSave}></Button>
        </View>
      </View>
    </ScrollView>
  );
